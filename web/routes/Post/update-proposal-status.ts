...
// let contractAddress = "0x408ED6354d4973f66138C91495F2f2FCbd8724C3"
// let proposalId = "24"

export async function updatePost(post: Post) {
  if (typeof window !== "undefined") {
    const res = await fetch(`${window.location.origin}/api/post-update.ts`, {
      method: "POST",
...
export async function queryProposalState(proposalId: string) {
  let contractAddress = "0x408ED6354d4973f66138C91495F2f2FCbd8724C3";
  let daoContract = new ethers.Contract(contractAddress, abi, provider);
  let state = await daoContract.state(proposalId);
  return state;
}
